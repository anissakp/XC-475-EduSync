    ...
    <div className=" hidden lg:inline-flex lg:w-[25rem] h-11 px-[42px] bg-custom-yellow rounded-2xl justify-center items-center gap-[26px]">
      {views.map((view) => (
        <button
          ...
          className={`p-2.5 justify-center items-center gap-2.5 flex rounded-2xl ${selectedView === view ? "h-11 px-8 py-2.5 bg-white rounded-2xl shadow justify-center items-center font-semibold" : "bg-custom-yellow"
            } hover:bg-white`}
        >
          <div
