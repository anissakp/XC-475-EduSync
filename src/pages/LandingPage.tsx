    ...
    <>
      ...
      <div className="flex justify-center mt-24 md:mt-28 lg:mt-32 xl:mt-36">
        <div className="relative text-black text-xs ">
          ...
          <div className="animate-wiggle1 absolute z-20 top-[-2rem] left-[0rem] w-28 h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 xl:w-40 xl:h-40 bg-white rounded-full flex flex-col items-center justify-center text-center p-4"><h2 className="font-bold md:text-lg">Notes</h2><p className="text-xs">Take both quick and more detailed notes</p></div>
          <div className="animate-wiggle1 absolute z-20 left-[-4rem] bottom-1/3  w-28 h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 xl:w-40 xl:h-40  bg-white rounded-full flex flex-col items-center justify-center text-center p-4"><h2 className="font-bold md:text-lg">Notifications</h2><p>Stay alerted</p></div>
          <div className="animate-wiggle1 absolute z-20 right-[0rem] top-[-2rem] w-28 h-28 md:w-32 md:h-32 lg:w-36 lg:h-36  xl:w-40 xl:h-40 bg-white rounded-full flex flex-col items-center justify-center text-center p-4"><h2 className="font-bold md:text-lg">Tasks</h2><p>Remember, Prioritize, and Get Done</p></div>
          <div className="animate-wiggle1 absolute z-20 right-[-4rem] bottom-1/3  w-28 h-28 md:w-32 md:h-32  lg:w-36 lg:h-36 xl:w-40 xl:h-40  bg-white rounded-full flex flex-col items-center justify-center text-center p-4"><h2 className="font-bold md:text-lg">Community</h2><p>Share and discover others POVs</p></div>
          <div className="animate-wiggle1 absolute z-20 bottom-[-2rem] left-[0rem]  w-28 h-28 md:w-32 md:h-32  lg:w-36 lg:h-36 xl:w-40 xl:h-40  bg-white rounded-full flex flex-col items-center justify-center text-center p-4"><h2 className="font-bold md:text-lg">Calendar</h2><p>Manage your time and stay Up to Date</p></div>
          <div className="animate-wiggle1 absolute z-20 bottom-[-2rem] right-[0rem] w-28 h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 xl:w-40 xl:h-40  bg-white rounded-full flex flex-col items-center justify-center text-center p-4"><h2 className="font-bold md:text-lg">Course Integration</h2><p>Connect to different learning platforms</p></div>
        </div>
      </div>
      <Footer/>
    </>
